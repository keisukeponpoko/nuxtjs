...
<script>
  ...
  const oldArticle = '<h1>#3「欲しいモノがなければ、自分で作ればいい」ai.さん</h1>\n' +
    ...
    '<p>「結婚して夫と２人で暮らし始めてからですね。新婚のときに一通り家具はそろえたんですが、使っているうちに何か違うという気持ちが大きくなっていったんです。それで自分で角を削ったり取手をかえたりと、細かく改造していました」</p>\n' +
    ...
    '<p class="rc-question">ー今はどれくらいのペースでほげほげDIYをしてるんですか？</p>\n' +
